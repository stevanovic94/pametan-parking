...
export class ParkingService {
	...
	getAdminParkingLots(): Observable<ParkingLot[]> {
		return this.http.get<ParkingLot[]>(`${this.apiUrl}/parking-lots/admin`);
	}

	createParkingLot(request: CreateParkingLotRequest): Observable<ParkingLot> {
		return this.http.post<ParkingLot>(`${this.apiUrl}/parking-lots`, request);
	}
	...
	deactivateParkingLot(id: string): Observable<{
		message: string;
	...
	getAdminParkingSpaces(parkingLotId: string): Observable<ParkingSpace[]> {
	...
	deactivateParkingSpace(id: string): Observable<{
		message: string;
	...
	getParkingMapOverview(): Observable<ParkingLotOverview[]> {
		return this.http.get<ParkingLotOverview[]>(
			`${this.apiUrl}/parking-lots/map-overview`,
		);
	}

	getParkingLot(id: string): Observable<ParkingLot> {
		return this.http.get<ParkingLot>(`${this.apiUrl}/parking-lots/${id}`);
	}
	...
	getParkingSpace(id: string): Observable<ParkingSpace> {
		return this.http.get<ParkingSpace>(`${this.apiUrl}/parking-spaces/${id}`);
	}
}
