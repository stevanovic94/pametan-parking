...
export const routes: Routes = [
  ...
  },
  {
    path: 'login',
    loadComponent: () =>
      import('./features/authentication/login/login.page')
        .then(m => m.LoginPage),
  },
  {
    path: 'register',
    loadComponent: () =>
      import('./features/authentication/register/register.page')
        .then(m => m.RegisterPage),
  },
  {
    path: 'forbidden',
    loadComponent: () =>
      import('./features/errors/forbidden/forbidden.page')
  ...
  },
  {
    ...
    loadComponent: () =>
      import('./features/admin/parking-lots-admin/parking-lots-admin.page')
  ...
  },
  {
    ...
    loadComponent: () =>
      import('./features/admin/parking-spaces-admin/parking-spaces-admin.page')
