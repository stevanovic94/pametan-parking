...
export class ParkingSpacesController {
    ...
    @Get()
    findAll(@Query() query: ParkingSpacesQueryDto) {
    ...
    @Roles('ADMIN')
    findAllForAdmin(@Query() query: ParkingSpacesQueryDto) {
        return this.parkingSpacesService.findAllForAdmin(query);
    }
    ...
    updateOccupancy(
        ...
        return this.parkingSpacesService.updateOccupancy(id, dto);
    }
    ...
    deactivate(@Param('id') id: string) {
        return this.parkingSpacesService.deactivate(id);
    }
}